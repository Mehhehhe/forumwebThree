                ...
                <?php
                    ...
                    foreach ($query_select_comment as $resuut_select_comment) {
                     ...
                     if($resuut_select_post['id']==$_SESSION['user_id']&&$resuut_select_comment['id']!=$_SESSION['user_id']&&$_SESSION['user_status']!=2){
                         ?>
                         <div class="btn_edit">
                            <button type="submit" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modaldel2<?php echo $resuut_select_comment['id_comment'];?>" style="background:#ff0000; border: none;">Delete</button>
                         
                                    <div class="modal fade " id="modaldel2<?php echo $resuut_select_comment['id_comment'];?>" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modaldel2<?php echo $resuut_select_comment['id_comment'];?>" aria-hidden="true">
                        ...
                        if($resuut_select_comment['id']==$_SESSION['user_id']||$_SESSION['user_status']==2){
                            ...
                            <div class="btn_edit">    
                                <div class="container ">
                                    ...
                                    <div class="modal fade" id="modalCenter2<?php echo $resuut_select_comment['id_comment'];?>" tabindex="-1" role="dialog" aria-labelledby="modalCenterTitle<?php echo $resuut_select_comment['id_comment'];?>" aria-hidden="true">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div>
                                                            <textarea name="msg_comment" id="Edit forum content" cols="60" rows="10" placeholder="Write your content ..." style="width:100%" required></textarea>
                                                            </div>                                                
                                                        </div>                                                                                       
                                ...
                                <button type="submit" class="btn btn-primary " data-bs-toggle="modal" data-bs-target="#modalCenter2<?php echo $resuut_select_comment['id_comment'];?>">Edit</button>
                                <button type="submit" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modaldel2<?php echo $resuut_select_comment['id_comment'];?>" style="background:#ff0000; border: none;">Delete</button>
